    ...
    this.sides.forEach((side) => {
      removeAnimation.to(
        side.mesh.position,
        {
          ...
          x:
            (2 + Math.random() * 3) *
            (this.sheetSettings[side.id].ripSide - 0.5)
        },
        0
      );
      removeAnimation.to(
...
const images = [
  {
    texture: textureLoader.load("https://i.lensdump.com/i/RVkmpT.jpeg"),
    colors: [
      [192, 208, 220],
      [217, 190, 174]
    ]
...

  {
    texture: textureLoader.load(
      "https://images.unsplash.com/photo-1516822003754-cca485356ecb?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2NzA1NzYwMjU&ixlib=rb-4.0.3&q=80"
    ),
    colors: [
      [168, 163, 150],
      [218, 180, 141]
...
let currentImage = -1;
const textureRip = textureLoader.load(
  "https://assets.codepen.io/557388/rip.jpg"
);
const textureBorder = textureLoader.load(
  "https://assets.codepen.io/557388/border.png"
);
...
const extraImages = [
  {
    file:
      "https://images.unsplash.com/photo-1669837238989-fe14dd4eb7a3?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2NzA1NzQxMDQ&ixlib=rb-4.0.3&q=80",
    colors: [
      [208, 229, 224],
      [209, 209, 220]
    ]
  ...
  {
    file: "https://assets.codepen.io/557388/photo-2.jpg",
    colors: [
      [191, 192, 184],
      [217, 200, 170]
    ]
  ...
  {
    file: "https://assets.codepen.io/557388/photo-6.jpg",
    colors: [
      [217, 226, 233],
      [216, 220, 203]
    ]
  ...
  {
    file: "https://assets.codepen.io/557388/photo-7.jpg",
    colors: [
      [206, 221, 226],
      [219, 213, 222]
    ]
  ...
  {
    file: "https://assets.codepen.io/557388/photo-5.jpg",
    colors: [
      [199, 199, 210],
      [218, 203, 195]
    ]
